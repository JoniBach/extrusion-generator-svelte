...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}</style>`),U_=S(`<label class="field"> <br/> <input type="number" step="0.01"/></label>`),W_=S(`<button class="preset-btn"> </button>`),G_=S(`<div class="layout"><aside class="panel"><div class="panel-scroll"><h2 style="margin-top:0">Profile</h2> <!> <div class="presets"><p class="presets-label">Presets</p> <div class="preset-buttons"></div></div></div> <div class="panel-footer"><div class="buttons"><button>Apply</button> <button>Clear</button></div> <div class="buttons" style="margin-top: 0.5rem;"><button>Export STL</button></div></div></aside> <canvas style="flex:1;display:block;width:100%;height:100%;"></canvas></div>`);function K_(n,l){w(l,!0);let d,S={size:20,length:100,centerHoleDiameter:4.19,slotWidth:5.26,slotDepth:1.5,innerWidth:11.99,trapezoidBaseFromCenter:6.34,cornerRadius:1},T=[{name:`Default`,profile:{...S}},{name:`1010`,profile:{size:10,length:100,centerHoleDiameter:2.5,slotWidth:3,slotDepth:.9,innerWidth:6,trapezoidBaseFromCenter:3.2,cornerRadius:.5}},{name:`1515`,profile:{size:15,length:100,centerHoleDiameter:3.3,slotWidth:4,slotDepth:1.2,innerWidth:9,trapezoidBaseFromCenter:4.8,cornerRadius:.8}},{name:`2020`,profile:{size:20,length:100,centerHoleDiameter:4.2,slotWidth:5.3,slotDepth:1.55,innerWidth:12,trapezoidBaseFromCenter:6.35,cornerRadius:1}},{name:`3030`,profile:{size:30,length:100,centerHoleDiameter:6.8,slotWidth:8.2,slotDepth:2,innerWidth:18,trapezoidBaseFromCenter:9.5,cornerRadius:1.5}},{name:`4040`,profile:{size:40,length:100,centerHoleDiameter:8.1,slotWidth:8.2,slotDepth:2.2,innerWidth:24,trapezoidBaseFromCenter:12.5,cornerRadius:2}}],E=a(r({...S})),D=[{key:`size`,label:`Size (mm)`},{key:`length`,label:`Length (mm)`},{key:`centerHoleDiameter`,label:`Center Hole Diameter (mm)`},{key:`slotWidth`,label:`Slot Width (mm)`},{key:`slotDepth`,label:`Slot Depth (mm)`},{key:`innerWidth`,label:`Inner Width (mm)`},{key:`trapezoidBaseFromCenter`,label:`Trapezoid Base From Center (mm)`},{key:`cornerRadius`,label:`Corner Radius (mm)`}];function O(e){let t=Ts(e),n=[],r=t.polygons;for(let e of r){let t=e.vertices;for(let e=1;e<t.length-1;e++)n.push(...t[0],...t[e],...t[e+1])}let i=new zd;return i.setAttribute(`position`,new Dd(n,3)),i.computeVertexNormals(),i.center(),i}let k=null,A=null,j=a(r({...S})),M=t(()=>Object.keys(s(E)).some(e=>s(E)[e]!==s(j)[e]));function N(e){i(E,{...e.profile},!0)}function P(){if(!k||!A)return;let e=O(s(E));k.geometry.dispose(),k.geometry=e,A.geometry.dispose(),A.geometry=new Uf(e,15),i(j,{...s(E)},!0)}function ee(){i(E,{...s(j)},!0)}v(()=>{let e=new v_({canvas:d,antialias:!0});e.setPixelRatio(devicePixelRatio);let t=new Gu;t.background=new Z(1710618);let n=new Mp(45,d.clientWidth/d.clientHeight,.1,1e3);n.position.set(80,60,120),n.lookAt(0,0,0);let r=new ResizeObserver(()=>{let t=d.clientWidth,r=d.clientHeight;e.setSize(t,r,!1),n.aspect=t/r,n.updateProjectionMatrix()});r.observe(d);let i=new k_(n,d);i.enableDamping=!0,t.add(new Ip(16777215,.4));let a=new Fp(16777215,1.5);a.position.set(100,100,100),t.add(a);let o=new Fp(16777215,.8);o.position.set(-100,50,-50),t.add(o);let c=new Fp(16777215,1);c.position.set(0,-100,-100),t.add(c);let l=O(s(E)),u=new Lu;k=new lf(l,new tp({color:8947848,metalness:.3,roughness:.5})),u.add(k),A=new Nf(new Uf(l,15),new xf({color:0,transparent:!0,opacity:.3})),u.add(A),t.add(u),k.geometry.computeBoundingBox();let f=new J;k.geometry.boundingBox.getSize(f);let p=Math.max(f.x,f.y,f.z)*1.8;i.target.set(0,0,0),n.position.set(p*.5,p*.4,p),n.lookAt(0,0,0),i.update();let m;function h(){m=requestAnimationFrame(h),i.update(),e.render(t,n)}return h(),()=>{cancelAnimationFrame(m),r.disconnect(),e.dispose(),k?.geometry.dispose(),A?.geometry.dispose(),k=null,A=null}});function te(){if(!k)return;let e=k.geometry,t=e.getAttribute(`position`),n=e.getIndex(),r=n?n.count/3:t.count/3,i=new Uint8Array(80);i.set(new TextEncoder().encode(`Exported from Svelte Extrusion Generator`),0);let a=new ArrayBuffer(84+r*50),o=new DataView(a);new Uint8Array(a,0,80).set(i),o.setUint32(80,r,!0);let s=84;for(let e=0;e<r;e++){let r=n?n.array[e*3]:e*3,i=n?n.array[e*3+1]:e*3+1,a=n?n.array[e*3+2]:e*3+2,c=t.getX(r),l=t.getY(r),u=t.getZ(r),d=t.getX(i),f=t.getY(i),p=t.getZ(i),m=t.getX(a),h=t.getY(a),g=t.getZ(a),_=(f-l)*(g-u)-(p-u)*(h-l),v=(p-u)*(m-c)-(d-c)*(g-u),y=(d-c)*(h-l)-(f-l)*(m-c);o.setFloat32(s,_,!0),s+=4,o.setFloat32(s,v,!0),s+=4,o.setFloat32(s,y,!0),s+=4,o.setFloat32(s,c,!0),s+=4,o.setFloat32(s,l,!0),s+=4,o.setFloat32(s,u,!0),s+=4,o.setFloat32(s,d,!0),s+=4,o.setFloat32(s,f,!0),s+=4,o.setFloat32(s,p,!0),s+=4,o.setFloat32(s,m,!0),s+=4,o.setFloat32(s,h,!0),s+=4,o.setFloat32(s,g,!0),s+=4,o.setUint16(s,0,!0),s+=2}let c=new Blob([a],{type:`application/octet-stream`}),l=URL.createObjectURL(c),u=document.createElement(`a`);u.href=l,u.download=`extrusion.stl`,u.click(),URL.revokeObjectURL(l)}var ne=G_();x(`1uha8ag`,e=>{p(e,H_())});var re=g(ne),ie=g(re),ae=h(g(ie),2);b(ae,17,()=>D,({key:e,label:t})=>e,(t,n)=>{let r=()=>s(n).key,a=()=>s(n).label;var o=U_(),l=g(o,!0),u=h(l,3);y(u),c(o),e(()=>{m(l,a()),f(u,s(E)[r()]),_(u,`outline: 2px solid ${s(E)[r()]===s(j)[r()]?`grey`:`#f59e0b`}`)}),C(`input`,u,e=>i(E,{...s(E),[r()]:parseFloat(e.target.value)},!0)),p(t,o)});var oe=h(ae,2),se=h(g(oe),2);b(se,21,()=>T,e=>e.name,(t,n)=>{var r=W_(),i=g(r,!0);c(r),e(()=>m(i,s(n).name)),C(`click`,r,()=>N(s(n))),p(t,r)}),c(se),c(oe),c(ie);var ce=h(ie,2),le=g(ce),ue=g(le),de=h(ue,2);c(le);var fe=h(le,2),pe=g(fe);c(fe),c(ce),c(re),u(h(re,2),e=>d=e,()=>d),c(ne),e(()=>{ue.disabled=!s(M),de.disabled=!s(M)}),C(`click`,ue,P),C(`click`,de,ee),C(`click`,pe,te),p(n,ne),o()}d([`input`,`click`]);export{K_ as component};